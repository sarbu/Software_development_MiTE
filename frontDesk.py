...
def isSameDay(d1,d2):
    ...
    ## If dealing with 2015/11/12 and 2016/11/12
    # add the following:     and (d1.year == d2.year)
    # to the flag line
...
while (inp != 'q'):
    try: 
        ...
        # CANCEL A RESERVATION
            ...
            #index is number of services for each guest. Start counting from 1 not 0!
        ...
        # GETTING SOMEONE'S BILL
            ...
            print 'SEARCHING AVAILABILITY OF SERVICE... '
            sid = input('ENTER SERVICE ID: ')
